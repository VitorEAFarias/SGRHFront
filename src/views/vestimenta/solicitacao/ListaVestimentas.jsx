...
const ListaVestimentas = _ => {
    ...
    useEffect(() => {
        const loadSolicitacoes = async () => {
            ...
            if(user.admin)
            {
                res = await Api.queryGet('/controllervestpedidos/status/1');
            }
            else
            {
                ...
                <div className='card-body'>
                    ...
                    <div className="row mb-3">
                        <div className='col-lg-6'>
                            <Link to={`/listaoPedidoVestimentas`} className="btn btn-inverse-primary mr-3">Lista de Solicitação Unificada</Link>
                        </div>
                        <div className="col-lg-6 text-right">
                            <Link to={`/listaVestimentasFinalizadas`} className="btn btn-inverse-primary mr-3">Lista de Solicitação Finalizada</Link>
                        </div>
                    </div>
                    }
                    <DataTable 
...
export default ListaVestimentas;